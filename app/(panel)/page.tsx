  ...
  return (
    <div className="mx-auto w-full max-w-3xl">
      ...
      <p className="mt-1 text-sm text-zinc-500">
        Gestiona catálogo y pedidos. El dashboard de métricas llega después.
      </p>
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        ...
        <Link
          ...
          className="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm transition hover:border-zinc-300"
        >
          <h2 className="font-medium text-zinc-900">Pedidos</h2>
          <p className="mt-1 text-sm text-zinc-500">
            Ver pedidos cerrados por el bot, su estado de pago y envío a Shalom.
          </p>
        </Link>
      </div>
    </div>
